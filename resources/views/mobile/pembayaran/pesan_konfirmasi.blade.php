...
<body class=" menu-full header-image html" data-header="light" data-footer="light" data-header_align="app"
    ...
    <div class="content-area">
        ...
        <div class="container has-pagehead is-pagetitle">
            <div class="section">
                <h5 class="pagetitle">KONFIRMASI PEMBAYARAN </h5>
            </div>
        </div>
            ...
            <div class="section">
                <div class="row ">
                    <div class="col s12 pad-0">
                        <h5 class="bot-20 sec-tit  ">Konfirmasi</h5>
                        <h4 style="text-align:center">Selamat anda telah berhasil mengirim bukti pembayaran</h4>
                        <div class="" style="display:flex; justify-content:center; align-items:center;">
                            <a href="/mobile/dashboard" class="btn btn-primary" style="text-align:center">Kembali ke
                                Beranda</a>
                        </div>
