...
<head>
    ...
    <title>Pembayaran | Mark Kost</title>
...
<body class=" menu-full header-image html" data-header="light" data-footer="light" data-header_align="app"
    ...
    <div class="content-area">
        ...
        <div class="container has-pagehead is-pagetitle">
            <div class="section">
                <h5 class="pagetitle">PEMBAYARAN {{ $transaksi->booking->datakost->nama_kost }}</h5>
            </div>
        </div>
            ...
            <div class="section">
                <div class="row ">
                    <div class="col s12 pad-0">
                        ...
                        <form action="{{ route('mobile.pembayaran.konfirmasi', Request::segment(3)) }}"
                            ...
                            <div class="card gray darken-1">
                                <div class="card-content">
                                    <div id="transfer">
                                        <input type="hidden" name="rekening_id" value="{{ Request::segment(3) }}">
                                        <div class="mb-3">
                                            <label for="" class="form-label">Nama Pengirim</label>
                                            <input type="text" name="nama_pengirim" placeholder="Nama Pengirim"
                                                value="{{ \App\Models\Transfer::where('transaksi_id', $transaksi->id)->first()->nama_pengirim }}"
                                                class="form-control" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label for="nama_bank_tujuan" class="form-label">Nama Bank Tujuan</label>
                                            <input type="text" name="nama_bank_tujuan"
                                                value="{{ $transaksi->rekening->nama_bank }}"
                                                placeholder="Nama Bank Tujuan" class="form-control" readonly>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_rekening"
                                                ...
                                                value="{{ $transaksi->rekening->nama_rekening }}" id="nama_rekening"
                                                readonly>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nomor_rekening"
                                                ...
                                                value="{{ $transaksi->rekening->nomor_rekening }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nominal" placeholder="Nominal Pembayaran"
                                            value="{{ number_format($transaksi->total) }}" class="form-control"
                                            id="nominal" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="tgl_transfer" class="form-label">Tanggal Transfer</label>
                                        <input type="date" name="tgl_transfer" placeholder="Nama Rekening Tujuan"
                                            class="form-control" id="tgl_transfer">

                                    </div>

                                    <div class="mb-3">
                                        <label for="bukti_transfer" class="form-label">Bukti Pembayaran</label><br>
                                        <input type="file" name="bukti_transfer" class="form-control"
                                            id="bukti_transfer">
                                    </div>
                                </div>
                                <div class="card-action">
                                    <input type="submit" value="Kirim Bukti Pembayaran" class="btn btn-primary">
                                </div>
                            </div>
                        </form>
                        <div class="text-center">
                            <p style="text-center" style="color:red !important;">Silahkan transfer sesuai dengan
                                nominal
                                pembayaran</p>
                        </div>
