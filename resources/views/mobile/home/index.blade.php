...
<body class=" menu-full header-image html" data-header="light" data-footer="light" data-header_align="app"
    ...
    <nav class="fix_topscroll logo_on_fixed  topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" href="index.html" class=" brand-logo ">Markkost</a>
    ...
    <ul id="slide-nav" class="sidenav sidemenu">
        ...
        <li class="menulinks">
            <ul class="collapsible">
                ...
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="sub-home.html">
                            ...
                            <span class="title">Welcome Pages</span></a>
                    </div>
                </li>
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="ui-apps.html">
                            ...
                            <span class="title">Inbuilt Apps</span><span class="badge">9</span></a>
                    </div>
                </li>
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="sub-interface.html">
                            ...
                            <span class="title">Interface</span></a>
                    </div>
                </li>
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="sub-pages.html">
                            ...
                            <span class="title">Pages</span><span class="badge">9</span></a>
                    </div>
                </li>
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="sub-media.html">
                ...
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="sub-features.html">
                            <i class="mdi mdi-beaker"></i>
                            <span class="title">Features</span></a>
                    </div>
                </li>
                <li class="lvl1 ">
                    <div class=" waves-effect   index ">
                        <a href="sub-account.html">
                            ...
                            <span class="title">Account</span><span class="badge">9</span></a>
                    </div>
                </li>
                <li class="lvl1 ">
                    <div class="waves-effect "><a href="#" data-target="slide-settings"
                            class="sidenav-trigger"><i class="mdi mdi-settings-outline"></i><span
    ...
    <div class="content-area">
        ...
        <div class="carousel carousel-fullscreen carousel-slider home_carousel carousel-dashboard-home">
            ...
            @foreach ($datakost as $dtkost)
                <a class="carousel-item" href="#carousel-slide-{{ $href }}!">
                    <div class="bg"
                        style="background-image: url('{{ asset('/') }}{{ env('ASSET_UPLOAD') }}gambarkost/{{ $dtkost->gambar }}')">
                    </div>
                    <div class="item-content center-align white-text">
                        <div class="spacer-large"></div>
                        <h3>{{ $dtkost->nama_kost }}</h3>
                        <h5 class="light white-text">Fasilitas<br>{{ $dtkost->fasilitas }}</h5>
                    </div>
                </a>
                @php $href++; @endphp
            @endforeach
        ...
        <div class="container">
            <div class="section pb0">
                ...
                <h4>Cara Booking Kost</h4>
                <div class="row">
                    <div class="col s12 pad-0">
                        <iframe width="100%" height="315"
                            src="{{ \App\Models\Setting::find(1)->video_tutorial }}" title="YouTube video player"
                            frameborder="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="tagline ">
                                                            Harian: Rp. {{ number_format($dtkost->harga_harian) }} <br>
                                                            Mingguan: Rp. {{ number_format($dtkost->harga_mingguan) }}
                                                            <br>
                                                            Bulanan: Rp. {{ number_format($dtkost->harga_bulanan) }}
                                                            <br>
                                                            Tahunan: Rp. {{ number_format($dtkost->harga_tahunan) }}
                                                            <br>
