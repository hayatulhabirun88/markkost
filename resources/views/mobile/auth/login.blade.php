    ...
    <div class="content-area">
        ...
        <div class="container login-area">
            <div class="section">
                ...
                @if (session('success'))
                    <span
                        style="display: flex; text-align:center; justify-content:center;font-size:20px;">{{ session('success') }}</span>
                @endif
                ...
                <div class="links">
                    ...
                    <p style="color:white;">Belum memiliki akun ? <a href="/mobile/registrasi">Registrasi</a></p>
                </div>
